...
3. **이론적 배경** — 이 연구가 기대고 있는 핵심 교육학적 이론이나 기술적 프레임워크 10줄 가량서술
4. **핵심 주장** — bullet point 3-5개에 대한 상세한 부연 설명
5. **방법론** — 연구 설계, 참가자, 측정 도구 등을 포함한 한두 단락의 상세 설명
6. **주요 발견** — bullet point를 활용하되 자세하고 구체적인 연구 결과(통계치 포함 권장) 제시
7. **교육공학적 함의** — 실천적 시사점 10줄 가량 (AI 교육 맥락에서의 의미를 깊이 있게 강조)
8. **연결 노트** — 관련 개념, 저자, 저널 wikilink
